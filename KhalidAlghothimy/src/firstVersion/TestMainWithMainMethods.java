...
public class TestMainWithMainMethods {
	    ...
	    public static void main(String[] args) {
	        ...
	        System.out.println("Total volume: " + total_volume + " m3");
	        ...
	        else if(total_volume <= (big_container_volume + small_container_volume)){
	        ...
	        if(total_weight <= 500000){
	            ...
	            System.out.println("Shipping cost: 1800 Euros");
